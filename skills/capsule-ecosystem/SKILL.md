...
proactive_trigger_1_condition: "новая капсула или полная настройка бота"
proactive_trigger_1_action: "запустить полный workflow настройки"
proactive_trigger_2_type: event
proactive_trigger_2_condition: "обновление эталона"
proactive_trigger_2_action: "пропагировать изменения в активные капсулы"
...
### 2026-03-19 — создание + развёртывание на Марину, Юлию, Максима
- Установлена полная экосистема: Марина (CLAUDE.md+diary+memory+corrections+маркеры), Юлия (то же + Docker rebuild), Максим (аудит + патч, +6 скиллов → 30 total, деплой на 45.11.93.179)
- Урок: client-capsule (Docker инфра) и capsule-ecosystem (софт/мозг) — дополняют друг друга, не дублируют (815+ строк суммарно)

### 2026-03-21 — расширение чеклиста v2.2/v2.3
- Добавлено: skills auto-discovery, hot-reload CLAUDE.md, proactive модуль, tools auto-discovery, inline menu
- Docker volumes: skills/ и tools/ монтируются read-only (:ro)
- Diary metadata расширен: model, duration, tools_used, success
- Команда /reload: owner-only, сброс mtime кеша, показывает кол-во skills+tools

### 2026-03-31 — массовая раскатка скиллов + bridge context
- Аудит скиллов всех капсул: Марина 17, Виктория 0(!), Яна 3, Никита 4, Юлия 37
- Раскатка baseline 11 скиллов на ВСЕ капсулы
- Bridge context расширен: CLAUDE.md без лимита, learnings 8K, corrections 6K, diary 3 дня
- Антипаттерн: скиллы надо раскатывать СРАЗУ при создании капсулы. Виктория 0 скиллов = пропущен этап
- Урок: encoding fix нужен при деплое (Victoria UTF-8 проблемы)
