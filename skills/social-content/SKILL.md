...
## Content Strategy: 11 категорий прогрева (Пыриков)

Вместо абстрактных "пиллар-тем" используй 11 конкретных категорий, которые последовательно прогревают аудиторию от подписки до покупки.

| # | Категория | Что публиковать | Цель |
|---|-----------|-----------------|------|
| 1 | **Бэкграунд** | Личная история, путь, трансформация | Доверие через уязвимость |
| 2 | **Лайфстайл** | Рабочий день, офис, процесс, рутина | Близость, "свой человек" |
| 3 | **Продающая тема** | Тренды индустрии, почему это важно сейчас | Осознание потребности |
| 4 | **Экспертность** | Туториалы, разборы, глубокий контент | Авторитет |
| 5 | **Инфоповоды** | Реакция на новости, события, хайп | Актуальность, охваты |
| 6 | **Клиенты** | Кейсы, результаты, до/после | Социальное доказательство |
| 7 | **Ученики/студенты** | Отзывы, пользовательские истории | Proof через третьих лиц |
| 8 | **Продукт** | Фичи, обновления, закулисье создания | Понимание ценности |
| 9 | **Срочность** | Ограниченные предложения, дедлайны | Триггер действия |
| 10 | **Бесплатное мероприятие** | Вебинары, эфиры, мастер-классы | Лидогенерация |
| 11 | **Продажи через блог** | Прямые CTA, цены, условия | Конверсия |

### Недельный микс

**70% ценность** (категории 1-5) — **20% личность** (6-8) — **10% продажи** (9-11)

Нарушение пропорции в сторону продаж (>30%) убивает охваты и доверие.
...
## Продуктовая матрица контента (НЕЧ20)

Каждый пост — элемент воронки. Определи роль контента ДО написания.

| Роль | Что это | Пример контента | CTA |
|------|---------|-----------------|-----|
| **Lead magnet** | Бесплатная ценность → захват контакта | Чеклист, гайд, шаблон | "Скачай бесплатно" |
| **Tripwire** | Дешёвый вход → конверсия наблюдателя в покупателя | Мини-курс 490₽, платный эфир | "Попробуй за 490₽" |
| **Main product** | Истории трансформации → основные продажи | Кейсы до/после, отзывы | "Записывайся на курс" |
| **Maximizer** | Допродажа внутри клиентской базы | Апгрейды, VIP-тарифы, бандлы | "Перейди на PRO" |
| **Retention** | Удержание через сообщество | Инсайдерский контент, закрытый чат | "Только для участников" |

Принцип: 80% контента = Lead magnet + Main product. Tripwire и Maximizer — точечно.

---

## CTA и уровень стресса (НЕЧ20)

**Правило:** стресс CTA не должен превышать уровень доверия аудитории.

| Аудитория | Уровень доверия | Допустимые CTA |
|-----------|-----------------|----------------|
| **Холодная** (новые подписчики) | Низкий | "Подпишись", "Сохрани", "Поделись" |
| **Тёплая** (читают 2+ недели) | Средний | "Напиши в комментарии", "Скачай гайд", "Приходи на эфир" |
| **Горячая** (взаимодействовали) | Высокий | "Записывайся", "Купи", "Оставь заявку" |

Нарушение = "продажа на первом свидании". Пост с "Купи!" для холодной аудитории — потеря подписчиков.
...
Каждый заголовок проверяй по 4 параметрам:

| U | Что это | Слабо | Сильно |
|---|---------|-------|--------|
| **Usefulness** | Полезность для читателя | "Советы по продажам" | "Как закрывать 8 из 10 сделок" |
| **Ultra-specificity** | Конкретика, цифры | "Быстро заработать" | "47 329₽ за 3 недели на холодном трафике" |
| **Uniqueness** | Чем отличается от 1000 таких же | "Как вести блог" | "Как вести блог если у тебя 0 подписчиков и нет экспертности" |
| **Urgency** | Почему сейчас, а не потом | "Полезный гайд" | "До блокировки осталось 3 дня — скачай сейчас" |

**Примеры:**
- `❌` "Как продавать в Telegram" (1U — только полезность)
- `✅` "Как я сделал 312 000₽ в Telegram-канале на 200 подписчиков за март — без рекламы" (все 4U)

---

## Убийцы и бустеры охватов (Тимочко)

### 12 убийц охватов
1. Скучный контент без эмоций и конфликта
2. Стена текста без структуры (нет абзацев, списков, выделений)
3. Нерегулярный постинг (пробелы >3 дней)
4. Более 30% продающего контента
5. Нет визуала или плохой визуал
6. Непонятное позиционирование канала ("обо всём и ни о чём")
7. Негатив, нытьё, жалобы
8. Копипаст / рерайт чужого без добавленной ценности
9. Нет взаимодействия с аудиторией (монолог)
10. Слишком много хэштегов (>5 на пост)
11. Постинг в мёртвое время (ночь, раннее утро буднего дня)
12. Нет сериальности (каждый пост — отдельный, нет рубрик и серий)

### 13 бустеров охватов
1. **Сторителлинг** — личные истории с конфликтом и развязкой
2. **Конкретные цифры** — "312 000₽" вместо "хорошо заработал"
3. **Провокационные заголовки** (не кликбейт!) — "Я перестал вести Stories и вот что случилось"
4. **Серии постов** — "День 1 из 30", "Часть 2/5" — удерживают подписчиков
5. **Опросы и вопросы** — вовлекают в диалог
6. **Репосты и коллаборации** — обмен аудиториями
7. **Визуальный контент** — карусели, инфографика, видео
8. **Регулярность** — алгоритмы любят предсказуемость
9. **Хайповые темы** — реакция на тренды в первые 24 часа
10. **UGC** (пользовательский контент) — отзывы, скриншоты переписок
11. **Закулисье** — процесс работы, ошибки, честность
12. **Списки и чеклисты** — структурированная ценность, высокий save rate
13. **Неожиданный ракурс** — знакомая тема через непривычную призму
...
- **Пыриков** (TG-запуски) — 11 категорий прогрева, недельный микс
- **Тимочко** (Денежный блог) — убийцы/бустеры охватов
- **НЕЧ20** (ConversionArt) — продуктовая матрица, CTA-стресс, 4U формула
...
- **headline-lab**: For testing headline variations with 4U formula
- **marketing-psychology**: For understanding what drives engagement
- **brand-voice-clone**: For extracting and replicating channel voice style
- **carousel-creator**: For Instagram carousel production
- **viral-reels-psychology**: For Reels/Shorts hook strategies
- **channel-autopilot**: For automated posting to Telegram channels
